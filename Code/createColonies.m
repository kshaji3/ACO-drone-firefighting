function [ colony ] = createColonies( graph, droneNo, colony , antNo, tau, eta, alpha,  beta)
    nodeNo = graph.n;
    for i = 1 : antNo
        ...
        for j = 2 : nodeNo % to choose the rest of nodes 
            ...
            P_allNodes(colony(droneNo).ant(i).tour) = 0 ;  % assing 0 to all the nodes visited so far
